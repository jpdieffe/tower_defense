    ...
    const panel = el(
      ...
      el(
        ...
        el(
          ...
          el('h3', {}, 'How to play'),
          el('div', { class: 'muted' },
            'Pick a tower, drag it onto a green tile and release. Tap a tower to upgrade it. '
            + 'Tap anywhere else to send your hero there. Use the shop between waves.'),
        ),
      ...
      el(
        ...
        el(
          ...
          el(
            ...
            statBox('Towers built', String(me.towersBuilt), false),
